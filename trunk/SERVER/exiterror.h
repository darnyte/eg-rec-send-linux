...
#define ERROR_CONFIG_FILE_UNKNOWN				40
#define ERROR_CONFIG_FILE_READING				41
#define ERROR_CONFIG_FILE_PARSING				42



#define ERROR_FORKING					        50
#define ERROR_CREATING_NEW_SID                  51
#define ERROR_SETTING_WORKING_DIRECTORY         52
#define ERROR_DROPPING_ROOT_PRIVILEGES          53



#define ERROR_CLOSING_CLIENT_SOCKET             100
#define ERROR_CLOSING_LISTENING_SOCKET          101
#define ERROR_GETTING_NET_BYTE_ORDER_IP_ADDRESS 102
#define ERROR_BINDING_TO_IP_ADDRESS             103
#define ERROR_LISTENING                         104
#define ERROR_ACCEPTING_NEW_CONNECTION          105
#define ERROR_SETTING_SOCKET_OPTIONS			106
#define ERROR_SETTING_SOCKET_TIME_OUTS			107

#define ERROR_FORKING_FOR_NEW_CLIENT            200


#define ERROR_PROMOTING_SOCKET_TO_FILE			300
#define ERROR_READING_MAGIC_WORD				301
#define ERROR_BAD_MAGIC_WORD					302
#define ERROR_WRITING_COOKIE                 	303
#define ERROR_READING_HASH						304
#define ERROR_WRITING_ACCEPT_MSG				305
#define ERROR_READING_EVENT						306
#define ERROR_EVENT_LINE_TOO_LONG				307

#define ERROR_GENERATING_PASSWORD_COOKIE		400
#define ERROR_CALCULATING_HASH					401
#define ERROR_HASH_DOES_NOT_MATCH				402


#define ERROR_EXECUTING_COMMAND					500



#define ERROR_INTERRUPTED						600
#define ERROR_UNEXPECTED						601
#define ERROR_SEGMENTATION_FAULT				602
